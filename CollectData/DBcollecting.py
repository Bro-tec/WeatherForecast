...
db.CreateTable(sqltemperature, "CREATE TABLE IF NOT EXISTS temperature(Cityname Varchar(20), long double, lat double);")
db.CreateTable(sqlcloudiness, "CREATE TABLE IF NOT EXISTS cloudiness(Cityname Varchar(20), long double, lat double);")
db.CreateTable(sqlextreme_wind, "CREATE TABLE IF NOT EXISTS extreme_wind(Cityname Varchar(20), long double, lat double);")
db.CreateTable(sqlmoisture, "CREATE TABLE IF NOT EXISTS moisture(Cityname Varchar(20), long double, lat double);")
